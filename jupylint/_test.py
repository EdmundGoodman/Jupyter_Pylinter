...
class TestJupylint(unittest.TestCase):
    ...
    def test_file_markdown_cells(self):
        ...
        json_content = Jupylint.get_json_content(
            "./jupylint/test_files/markdown_cells.ipynb"
        )
    ...
    def test_file_running_code(self):
        ...
        json_content = Jupylint.get_json_content(
            "./jupylint/test_files/running_code.ipynb"
        )
    ...
    def test_no_params(self):
        ...
        result = get_jupylint_output("python3 ./jupylint_runner.py".split(" "))
    ...
    def test_pylintrc_not_found(self):
        ...
        self.assertEqual(
            "The config file jupylint/test_files/no_pylintrc doesn't exist!\n\n", result
        )
